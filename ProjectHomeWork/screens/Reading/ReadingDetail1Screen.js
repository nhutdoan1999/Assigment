...
const ReadingDetail1Screen = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <Image source={{ uri: item.rea_doc_1 }} style={styles.image} />
                ...
                <Image source={{ uri: item.rea_doc_2 }} style={styles.image} />
                ...
                <Image source={{ uri: item.rea_doc_3 }} style={styles.image} />
...
export default ReadingDetail1Screen;
