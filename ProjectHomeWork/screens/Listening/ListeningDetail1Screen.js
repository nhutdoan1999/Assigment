...
const ListeningDetail1Screen = () => {
    ...
    useEffect(() => {
        // Thiết lập tùy chọn header với sự kiện quay lại
    ...
    const handleBackPress = () => {
        // Chuyển hướng về ListeningTestScreen khi bấm quay lại
        navigation.navigate('ListeningTestScreen');
    };
    ...
    const playAudio = (audioUrl) => {
        if (sound) {
            sound.stop(() => sound.release()); // Stop and release the previous sound
        }
    ...
    const submitAnswers = async () => {
        ...
        navigation.navigate('ResultScreen', { data: responseData }); // Navigate to ResultScreen
    };
        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.audioControls}>
                    <TouchableOpacity
                        onPress={() => handlePlayPause(item.lis_audio_1)}
                        style={styles.iconButton}
                    >
                        <Ionicons name={isPlaying ? "pause" : "play"} size={40} color="#4CAF50" />
                    </TouchableOpacity>
                ...
                <View style={styles.audioControls}>
                    <TouchableOpacity
                        onPress={() => handlePlayPause(item.lis_audio_2)}
                        style={styles.iconButton}
                    >
                        <Ionicons name={isPlaying ? "pause" : "play"} size={40} color="#4CAF50" />
                    </TouchableOpacity>
                ...
                <View style={styles.audioControls}>
                    <TouchableOpacity
                        onPress={() => handlePlayPause(item.lis_audio_3)}
                        style={styles.iconButton}
                    >
                        <Ionicons name={isPlaying ? "pause" : "play"} size={40} color="#4CAF50" />
                    </TouchableOpacity>
                ...
                <View style={styles.audioControls}>
                    <TouchableOpacity
                        onPress={() => handlePlayPause(item.lis_audio_4)}
                        style={styles.iconButton}
                    >
                        <Ionicons name={isPlaying ? "pause" : "play"} size={40} color="#4CAF50" />
                    </TouchableOpacity>
...
export default ListeningDetail1Screen;
