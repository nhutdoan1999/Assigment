...
const ResultScreen = ({ route, navigation }) => {  // Nhận navigation từ props
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                ...
                />
                <Button
                    title="Retake Listening Test"
                    onPress={() => navigation.navigate('ListeningTestScreen')}  // Sử dụng navigation
                    color="#FF9800"
                />
            </View>
        </View>
